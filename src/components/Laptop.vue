<template>
    <Page class="page" backgroundSpanUnderStatusBar="true">
        <ActionBar title="Đồng hồ G-Shock Special Limited">
            <NavigationButton
                text="Go back"
            ...
            <StackLayout  orientation="horizontal">
                <label text="Đồng hồ G-Shock Special Limited" width="70%" fontSize="20" fontWeight="bold" verticalAlignment="center"></label>
            ...
            <ScrollView>
                <StackLayout orientation="vertical" backgroundColor="#ffffff">
                    <GridLayout
                        ...
                        borderBottomWidth="1"
                        v-for="(laptop, i) in filteredLaptops"
                        :key="i"
                        >
                        <Image
                            col="0"
                        ...
                        <StackLayout
                            ...
                            paddingBottom="10"
                            >
                            <Label :text="laptop.title" color="#b30000" fontWeight="bold" />
                            <Label :text="'(' + laptop.price + ' VNĐ)'" />
...
<script>
    ...
    export default {
        ...
        computed: {
          filteredLaptops: function () {
    					var move_array = this.laptops,
    					...
    					move_array = move_array.filter(function(laptop){
    							if(laptop.title.toLowerCase().indexOf(searchedText) !== -1){
    									return laptop;
    							}
    					})
