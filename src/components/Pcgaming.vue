<template>
    <Page class="page" backgroundSpanUnderStatusBar="true">
        <ActionBar title="Đồng hồ G-Shock Nam MRG-G2000R">
            <NavigationButton
                text="Go back"
            ...
            <StackLayout  orientation="horizontal">
                <label text="Đồng hồ G-Shock Nam MRG-G2000R" width="70%" fontSize="20" fontWeight="bold" verticalAlignment="center"></label>
            ...
            <ScrollView>
                <StackLayout orientation="vertical" backgroundColor="#ffffff">
                    <GridLayout
                        ...
                        borderBottomWidth="1"
                        v-for="(pcgaming, i) in filteredPcgamings"
                        :key="i"
                        >
                        <Image
                            col="0"
                            :src="pcgaming.imageUrl"
                            marginRight="10"
                            marginLeft="10"
                            />
                        <StackLayout
                            ...
                            paddingBottom="10"
                            >
                            <Label :text="pcgaming.title" color="#b30000" fontWeight="bold" />
                            <Label :text="'(' + pcgaming.price + ' VNĐ)'" />
...
<script>
    ...
    export default {
        ...
        computed: {
          filteredPcgamings: function (newApp, old) {
    					var move_array = this.pcgamings,
    					...
    					move_array = move_array.filter(function(pcgaming){
    							if(pcgaming.title.toLowerCase().indexOf(searchedText) !== -1){
    									return pcgaming;
    							}
    					})
